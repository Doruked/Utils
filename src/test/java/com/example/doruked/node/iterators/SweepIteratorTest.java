...
//    }
    /**
     * @deprecated can be tested, but doesn't seem specifically worth it
     * most tests start from head in any regard.
     */
    @Deprecated
    @Test
    ...
    /**
     * @deprecated the iterator never returns to head, so the test does not work.
     * however, there is an expected last node that could be checked.
     */
    @Deprecated
    @Test
    ...
    /**
     * @deprecated not needed, the test was autogenerated by upon creating this class
     */
    @Deprecated
    @Test
    public void hasNext() {
